...
/* eslint-disable @typescript-eslint/naming-convention -- vueuse reusable template pattern from upstream docus */
  ...
  <DefineChatContent v-slot="{ showExpandButton = true }">
    <div class="flex h-full flex-col">
      ...
      <div class="w-full shrink-0 p-3">
        ...
        <div class="mt-1 flex text-xs text-muted items-center justify-between">
