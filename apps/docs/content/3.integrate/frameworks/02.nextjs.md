...
- [Wide Events](/learn/wide-events): 使用上下文分层设计全面的事件
- [Adapters](/integrate/adapters/overview): 将日志发送到 Axiom、Sentry、PostHog 等
- [Sampling](/learn/sampling): 使用头部采样和尾部采样控制日志量
- [Structured Errors](/learn/structured-errors): 抛出包含 `why`、`fix` 和 `link` 字段的错误
