...
添加 Sentry 排水器适配器，将 evlog 宽事件发送到 Sentry Logs。
...
- [Axiom Adapter](/integrate/adapters/cloud/axiom) - 将日志发送到 Axiom 以便查询和创建仪表盘
- [OTLP Adapter](/integrate/adapters/cloud/otlp) - 通过 OpenTelemetry Protocol 发送日志
- [PostHog Adapter](/integrate/adapters/cloud/posthog) - 将日志发送到 PostHog
- [Custom Adapters](/extend/custom-drains) - 构建你自己的适配器
