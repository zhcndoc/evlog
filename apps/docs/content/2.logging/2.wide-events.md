...
不是在使用 HTTP 框架？请参阅 [独立 TypeScript](/frameworks/standalone) 和 [Cloudflare Workers](/frameworks/cloudflare-workers)——宽事件在请求生命周期之外同样适用，且同样清晰。
::
...
文档：https://www.evlog.dev/logging/wide-events
最佳实践：https://www.evlog.dev/core-concepts/best-practices
