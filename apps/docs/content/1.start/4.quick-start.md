...
使用 evlog 的最简单方式。随时随地发送无需关注的已结构化日志：
...
查看完整的 [简单日志](/learn/simple-logging) 指南，了解所有模式和 drain 集成。
::
...
- [Logging Overview](/learn/overview): 了解三种日志模式
- [Wide Events](/learn/wide-events): 了解如何设计有效的广泛事件
- [Typed Fields](/learn/typed-fields): 为你的广泛事件添加编译时类型安全
- [Structured Errors](/learn/structured-errors): 掌握使用 evlog 的错误处理
- [Best Practices](/reference/best-practices): 安全指南和生产环境建议
