...
For scripts, queue workers, cron, and CLIs, this page is the reference. On Cloudflare Workers, prefer [Cloudflare Workers](/frameworks/cloudflare-workers) (`createWorkersLogger`).
::
