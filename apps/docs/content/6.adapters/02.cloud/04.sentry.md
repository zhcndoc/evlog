...
适配器文档：https://www.evlog.dev/adapters/cloud/sentry
...
- [Axiom 适配器](/adapters/cloud/axiom) - 将日志发送到 Axiom 以进行查询和仪表板展示
- [OTLP 适配器](/adapters/cloud/otlp) - 通过 OpenTelemetry Protocol 发送日志
- [PostHog 适配器](/adapters/cloud/posthog) - 将日志发送到 PostHog
- [自定义适配器](/adapters/building-blocks/custom) - 构建你自己的适配器
