...
适配器文档：https://www.evlog.dev/adapters/cloud/better-stack
...
- [Axiom Adapter](/adapters/cloud/axiom) - 将日志发送到 Axiom 以便查询和创建仪表板
- [OTLP Adapter](/adapters/cloud/otlp) - 通过 OpenTelemetry 协议发送日志
