...
如需改用基于 OpenTelemetry 的摄入，请参阅 [OTLP 适配器](/adapters/cloud/otlp)。
...
适配器文档：https://www.evlog.dev/adapters/cloud/datadog
...
- [OTLP Adapter](/adapters/cloud/otlp) — 通过 OpenTelemetry 发送日志（适用于 Datadog Agent / OTLP 端点）
- [Custom Adapters](/adapters/building-blocks/custom) — 构建你自己的目标端
