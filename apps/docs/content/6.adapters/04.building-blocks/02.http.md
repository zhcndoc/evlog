...
- The drain batches events and uses fetch keepalive + sendBeacon on visibility change
- On the server, accept POST requests with a DrainContext[] body and forward them to my drain pipeline

Docs: https://www.evlog.dev/adapters/building-blocks/http
...
- [Pipeline](/adapters/building-blocks/pipeline) - Batching, retry, and buffer overflow handling
