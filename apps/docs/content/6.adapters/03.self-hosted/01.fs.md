...
适配器文档：https://www.evlog.dev/adapters/self-hosted/fs
...
- [Agent Skills](/getting-started/agent-skills) - 让 AI 分析你的日志
- [Axiom Adapter](/adapters/cloud/axiom) - 将日志发送到 Axiom 以进行查询和仪表板展示
- [Pipeline](/adapters/building-blocks/pipeline) - 为任何排放添加批处理和重试
